...
if(args$plots == TRUE){
  ...
  plot_density.wo(whole_pdf, file = paste0("whole_", prefix_fname, "_plot.pdf")) #red
  plot_density_log.wo(whole_pdf, file = paste0("whole_", prefix_fname, "_log_plot.pdf")) #red
  plot_density_zoom.wo(whole_pdf, zoom = 10, file = paste0("whole_", prefix_fname,"_zoom_plot.pdf")) #red
